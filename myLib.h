...
#define RED COLOR(31,1,0)
#define GREEN COLOR(1,31,0)
#define BLUE COLOR(1,1,31)
...
#define BUTTON_TRANSIT(key) (((BUTTONS) ^ (oldButtons)) & (key))
...
#define BG_PRIO0 0      // priority
#define BG_PRIO1 1      // 64 x 32
#define BG_PRIO2 2      // 32 x 64
#define BG_PRIO3 3      // 64 x 64
